...
class SimCSEEntityTokensTrainer():
    """
    ...
    def _train_epoch(self, epoch):
        ...
        for i, batch in enumerate(pbar):
            ...
            logits1 = self.model(input_ids = batch["input_ids"].to(self.device),
                                ...
                                entity_embed1 = batch['entity_embed1'].to(self.device),
        ...
        with torch.no_grad():
            ...
            for valid_batch in tqdm(self.valid_dataloader):
                ...
                logits1 = self.model(input_ids =valid_batch["input_ids"].to(self.device),
                                    ...
                                    entity_embed1 = valid_batch['entity_embed1'].to(self.device),
                                    entity_embed2 = valid_batch['entity_embed2'].to(self.device))
